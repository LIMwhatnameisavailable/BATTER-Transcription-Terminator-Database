...
|---|---|
| 发布判定 | `to_review` |
| 公开资产 | `data/records/BTED_EXT_2026_113/`（24 列端点表 + BED6） |
| 记录数 | 见端点表行数（`BTED_EXT_2026_113_endpoints.tsv`） |
| 主要证据层 | `NA`（挂起，原 `algorithm_called_endpoint`，待字典提案二正式采纳后升级） |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000005845.1 (ASM584v1)` |
| 参考序列 | `NC_000913.3` |
| 原始数据入口 | PRJNA906280 (SRP410342; SRR22439140-142) |
| 论文 | PMID [40586304](https://pubmed.ncbi.nlm.nih.gov/40586304/) · DOI [10.1093/nar/gkaf553](https://doi.org/10.1093/nar/gkaf553) |
