...
|---|---|
| 发布判定 | `to_review` |
| 公开资产 | `data/records/BTED_EXT_2026_109/`（24 列端点表 + BED6） |
| 记录数 | 见端点表行数（`BTED_EXT_2026_109_endpoints.tsv`） |
| 主要证据层 | `NA`（挂起，原 `algorithm_called_endpoint`，待字典提案二正式采纳后升级） |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000742975.1 (ASM74297v1)` |
| 参考序列 | `NZ_CP008814.1;NZ_CP008815.1;NZ_CP008816.1` |
| 原始数据入口 | PRJEB12568 (ERP014057; ERR1248401-428) |
| 论文 | PMID [27120414](https://pubmed.ncbi.nlm.nih.gov/27120414/) · DOI [10.1126/science.aad9822](https://doi.org/10.1126/science.aad9822) |
