...
| 公开资产 | `data/public/records/BATTER_S1_006/endpoints.tsv` |
| 记录数 | 1864 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000006885.1` |
| 原始数据入口 | https://www.ncbi.nlm.nih.gov/sra?term=SRP136114 |
| 论文 | PMID [30517198](https://pubmed.ncbi.nlm.nih.gov/30517198/) · DOI [10.1371/journal.ppat.1007461](https://doi.org/10.1371/journal.ppat.1007461) |

## 范围与证据边界

Author-called Term-seq TTS; author threshold and locus relationships are retained in the processing record.
