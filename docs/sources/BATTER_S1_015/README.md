...
| 公开资产 | `data/public/records/BATTER_S1_015/endpoints.tsv` |
| 记录数 | 1140 |
...
Author-published Term-seq endpoint; chromosome and plasmid are retained as separate contigs.
