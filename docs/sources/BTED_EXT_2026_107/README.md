...
|---|---|
| 发布判定 | `to_review` |
| 公开资产 | `data/records/BTED_EXT_2026_107/`（24 列端点表 + BED6） |
| 记录数 | 见端点表行数（`BTED_EXT_2026_107_endpoints.tsv`） |
| 主要证据层 | `NA`（挂起，原 `algorithm_called_endpoint`，待字典提案二正式采纳后升级） |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000009045.1 (ASM904v1)` |
| 参考序列 | `NC_000964.3` |
| 原始数据入口 | PRJNA646522 (SRP272134; SRR12232093-300) |
| 论文 | PMID [33835023](https://pubmed.ncbi.nlm.nih.gov/33835023/) · DOI [10.7554/eLife.61880](https://doi.org/10.7554/eLife.61880) |
