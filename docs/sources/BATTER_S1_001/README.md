...
| 公开资产 | `data/public/records/BATTER_S1_001/curated_records.tsv` |
| 记录数 | 607 |
| 主要证据层 | `curated_record` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000005845.1` |
...
Literature-curated experimental/sequence-supported intrinsic-terminator record; not a new local terminator call.
