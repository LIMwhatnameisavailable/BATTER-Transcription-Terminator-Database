...
| 公开资产 | `data/public/records/BATTER_S1_018/endpoints.tsv` |
| 记录数 | 487 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_018282115.1` |
| 原始数据入口 | https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJNA629670 |
| 论文 | PMID [34054774](https://pubmed.ncbi.nlm.nih.gov/34054774/) · DOI [10.3389/fmicb.2021.667450](https://doi.org/10.3389/fmicb.2021.667450) |

## 范围与证据边界

Author-called Term-seq TEP; all four published replicons are preserved.
