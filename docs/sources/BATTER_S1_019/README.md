...
| 公开资产 | `data/public/records/BATTER_S1_019/endpoints.tsv` |
| 记录数 | 784 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000009725.1` |
| 原始数据入口 | https://www.ncbi.nlm.nih.gov/bioproject/?term=PRJNA666973 |
| 论文 | PMID [34874777](https://pubmed.ncbi.nlm.nih.gov/34874777/) · DOI [10.1128/mSystems.00943-21](https://doi.org/10.1128/mSystems.00943-21) |

## 范围与证据边界

Author-called manually curated Term-seq TEP.
