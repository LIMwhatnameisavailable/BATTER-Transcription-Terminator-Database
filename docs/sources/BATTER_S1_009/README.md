...
| 公开资产 | `data/public/records/BATTER_S1_009/endpoints.tsv` |
| 记录数 | 2091 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_003054575.1` |
| 原始数据入口 | https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE139939 |
| 论文 | PMID [32694125](https://pubmed.ncbi.nlm.nih.gov/32694125/) · DOI [10.1128/mSystems.00250-20](https://doi.org/10.1128/mSystems.00250-20) |

## 范围与证据边界

Author-published Term-seq TTS after processing-site filtering; pure TransTermHP predictions are excluded.
