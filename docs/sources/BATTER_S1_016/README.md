...
| 公开资产 | `data/public/records/BATTER_S1_016/endpoints.tsv` |
| 记录数 | 870 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_015710995.1` |
...
Author-published Term-seq endpoint; taxonomy label conflict is retained in the source record.
