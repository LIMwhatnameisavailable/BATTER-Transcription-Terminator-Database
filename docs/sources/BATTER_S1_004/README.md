...
| 公开资产 | `data/public/records/BATTER_S1_004/curated_records.tsv` |
| 记录数 | 337 |
| 主要证据层 | `curated_record` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000022005.1` |
...
Literature-curated record; the retained GEO metadata conflict is documented in the source processing record.
