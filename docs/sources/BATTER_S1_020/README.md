...
| 公开资产 | `data/public/records/BATTER_S1_020/endpoints.tsv` |
| 记录数 | 1165 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000147055.1` |
| 原始数据入口 | https://www.ebi.ac.uk/biostudies/arrayexpress/studies/E-MTAB-10482 |
| 论文 | PMID [35491820](https://pubmed.ncbi.nlm.nih.gov/35491820/) · DOI [10.1128/mbio.00524-22](https://doi.org/10.1128/mbio.00524-22) |

## 范围与证据边界

Author-called Nanopore native RNA 3′ end. The mixed-evidence S1C table is excluded from this public asset.
