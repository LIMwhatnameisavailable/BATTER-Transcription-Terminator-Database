...
| 公开资产 | `data/public/records/BATTER_S1_013/endpoints.tsv` |
| 记录数 | 1208 |
...
Author-published Term-seq endpoint; independent from BATTER_S1_007 despite shared organism/reference.
