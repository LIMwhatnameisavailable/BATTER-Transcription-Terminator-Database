...
| 公开资产 | `data/public/records/BATTER_S1_008/endpoints.tsv` |
| 记录数 | 1965 |
| 主要证据层 | `author_called_endpoint` |
| 迁移日期 | 2026-08-10 |
| 参考组装 | `GCF_000006765.1` |
| 原始数据入口 | https://www.ebi.ac.uk/ena/browser/view/PRJEB31965 |
| 论文 | PMID [31594819](https://pubmed.ncbi.nlm.nih.gov/31594819/) · DOI [10.1128/mBio.02253-19](https://doi.org/10.1128/mBio.02253-19) |

## 范围与证据边界

Author-reported reproducible Term-seq 3′ sites (Table S1B); the separate gene-associated table is documented but not duplicated here.
